...
export(
	...
	"FULL_BANNER",
	"LEADERBOARD"
) var banner_size = "ADAPTIVE_BANNER"
...
func init() -> bool:
	if Engine.has_singleton("GodotAdMob"):
		...
		_admob_singleton.initWithContentRating(is_real, child_directed, is_personalized, max_ad_content_rate)
		return true
	return false
...
func connect_signals() -> void:
	...
	_admob_singleton.connect(
		"on_rewarded_interstitial_ad_failed_to_load", self, "_on_rewarded_interstitial_ad_failed_to_load"
	)
	_admob_singleton.connect(
		"on_rewarded_interstitial_ad_failed_to_show", self, "_on_rewarded_interstitial_ad_failed_to_show"
	)
